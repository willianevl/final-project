...
export default function ModalConfirm({ showModal, showLoading, action, actionCancel, titleButtom, msg }) {
			...
			<Grid container>
				...
				>
					...
					<Grid item xs={12}>
						...
						<ButtonDefault fullWidth type="button" loading={loading} title={titleButtom} action={action} />
					</Grid>
				</Paper>
			</Grid>
		</Modal>
